// lib/net fetchWithTimeout — 느린/죽은 원격에서 무한 대기(부팅 행·저장 멈춤) 방지.
// (구 lib/api.ts — Render REST 클라이언트는 2026-07-17 은퇴. 범용 유틸만 net 으로 이주.)
//
// 검증:
...
import {fetchWithTimeout, API_TIMEOUT_MS} from '../../lib/net';
