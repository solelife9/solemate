...
const s = StyleSheet.create({
  ...
  shoeModel: { color: T1, fontFamily: DISPLAY, fontSize: rf(23), fontWeight: '700', letterSpacing: -0.5, lineHeight: rf(27), marginTop: 4 },
  ...
  shoePurpose: { color: T3, fontFamily: FONT, fontSize: rf(14), fontWeight: '500', letterSpacing: -0.1, marginTop: 10 },
  ...
  shoeUsedU: { color: T3, fontFamily: FONT, fontSize: rf(14), fontWeight: '500', marginLeft: 2 },
  ...
  dModel: { color: T1, fontFamily: DISPLAY, fontSize: rf(32), fontWeight: '700', letterSpacing: -0.5, marginTop: 2, lineHeight: rf(38) },
  dPurpose: { color: T2, fontFamily: FONT, fontSize: rf(16), fontWeight: '500', letterSpacing: -0.2, lineHeight: rf(22), marginTop: 10 },
  ...
  dPurposeLabel: { color: T3, fontFamily: FONT, fontSize: rf(14), fontWeight: '600', marginTop: 16 },
  ...
  wearUnit: { color: T3, fontFamily: FONT, fontSize: rf(14), marginLeft: 4, marginBottom: 4 },
  wearTarget: { color: T3, fontFamily: FONT, fontSize: rf(14), marginBottom: 4 },
  wearForecast: { color: T3, fontFamily: FONT, fontSize: rf(14), fontWeight: '500', letterSpacing: -0.1, lineHeight: rf(18), marginTop: 8 },
  // 교체 예상 lead(핸드오프 lead 정합: 16px·lineHeight 23) + 주수 강조(bold·T1).
  replaceForecastText: { color: T2, fontFamily: FONT, fontSize: rf(17), fontWeight: '500', letterSpacing: -0.2, lineHeight: rf(23), marginTop: 8 },
  ...
  wearBasisText: { color: T3, fontFamily: FONT, fontSize: rf(14), fontWeight: '500', letterSpacing: -0.1, lineHeight: rf(18), marginTop: 8 },
  ...
  gaugeNote: { marginTop: 10, color: T3, fontFamily: FONT, fontSize: rf(13), lineHeight: rf(17) },
  ...
  dHeroRemainU: { color: T2, fontFamily: FONT, fontSize: rf(17), marginLeft: 5, marginBottom: 6 },

  editInput: { backgroundColor: CARD_HI, borderRadius: 14, color: T1, fontFamily: FONT, fontSize: rf(17), fontWeight: '500', paddingHorizontal: 16, paddingVertical: 13 },
  ...
  nextSub: { color: T3, fontFamily: FONT, fontSize: rf(14), lineHeight: rf(18), marginBottom: 6 },
  ...
  nextModel: { color: T1, fontFamily: DISPLAY, fontSize: rf(16), fontWeight: '600', letterSpacing: -0.1, marginTop: 3 },
  nextCat: { color: T3, fontFamily: FONT, fontSize: rf(12), marginTop: 3 },
  ...
  nextDisclosure: { color: T3, fontFamily: FONT, fontSize: rf(12), lineHeight: rf(15), marginTop: 12, opacity: 0.85 },
  ...
  shareLine: { color: T3, fontFamily: FONT, fontSize: rf(13), paddingHorizontal: 18, paddingBottom: 14, marginTop: -2 },
  statValue: { color: T1, fontFamily: DISPLAY, fontSize: rf(23), letterSpacing: 0.3 },
  statUnit: { color: T3, fontFamily: FONT, fontSize: rf(13) },
  statLabel: { color: T3, fontFamily: FONT, fontSize: rf(12), marginTop: 4 },
  ...
  maxInput: { color: T1, fontFamily: DISPLAY, fontSize: rf(29), letterSpacing: 0.3, textAlign: 'center', minWidth: 70, paddingVertical: 0, paddingBottom: 2, borderBottomWidth: 1, borderBottomColor: withAlpha(ACCENT, 0.4) },
  maxStepUnit: { color: T3, fontFamily: FONT, fontSize: rf(14), marginBottom: 3 },
  maxStepCaption: { color: T3, fontFamily: FONT, fontSize: rf(13), fontWeight: '600', marginTop: 3 },
  ...
  runDistU: { color: T3, fontFamily: FONT, fontSize: rf(14), marginLeft: 4, marginBottom: 1 },
  runSub: { color: T3, fontFamily: FONT, fontSize: rf(13), marginTop: 3 },
});
