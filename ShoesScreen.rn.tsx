      ...
      <ScrollView contentContainerStyle={{ padding: 18, paddingBottom: 28, gap: 16 }} keyboardShouldPersistTaps="handled">
        ...
        {shoeRuns.length === 0 ? (
          <View style={[s.card, { padding: 24, alignItems: 'center' }]}>
            <Text style={{ color: T3, fontFamily: FONT, fontSize: 14 }}>아직 기록이 없어요</Text>
          </View>
        ) : (
...
const s = StyleSheet.create({
  ...
  sectionLabel: { color: T3, fontFamily: FONT, fontSize: 14, fontWeight: '600', letterSpacing: 0.4, paddingHorizontal: 4 },
  dot: { width: 7, height: 7, borderRadius: RADIUS.pill },
  condText: { fontFamily: FONT, fontSize: 14, fontWeight: '500' },
  condSub: { color: T3, fontFamily: FONT, fontSize: 14 },
  ...
  title: { color: T1, fontFamily: FONT, fontSize: 29, fontWeight: '600', letterSpacing: -0.6 },
  ...
  addPillText: { color: T1, fontFamily: FONT, fontSize: 14, fontWeight: '600' },
  ...
  shoeBrand: { color: T3, fontFamily: DISPLAY, fontSize: 12, fontWeight: '500', letterSpacing: 1.3 },
  shoeUsing: { color: T3, fontFamily: FONT, fontSize: 13, fontWeight: '500' },
  shoeModel: { color: T1, fontFamily: DISPLAY, fontSize: 23, fontWeight: '700', letterSpacing: -0.5, lineHeight: 27, marginTop: 4 },
  ...
  cardTypeChipText: { color: ACCENT, fontFamily: FONT, fontSize: 11, fontWeight: '700', letterSpacing: 0.1 },
  // 추천 용도(러닝 종류) 한 줄 — 카드 중간
  shoePurpose: { color: T3, fontFamily: FONT, fontSize: 14, fontWeight: '500', letterSpacing: -0.1, marginTop: 10 },
  ...
  shoeCondText: { color: T2, fontFamily: FONT, fontSize: 14, fontWeight: '500' },
  ...
  shoeUsedNum: { color: T1, fontFamily: DISPLAY, fontSize: 26, fontWeight: '700', letterSpacing: -0.6 },
  shoeUsedU: { color: T3, fontFamily: FONT, fontSize: 14, fontWeight: '500', marginLeft: 2 },
  shoeRemain: { color: T3, fontFamily: FONT, fontSize: 14, fontWeight: '500' },
  ...
  soonText: { color: T2, fontFamily: FONT, fontSize: 14, fontWeight: '500' },
  soonStrong: { color: WARN, fontWeight: '700' },
  shoePaceVal: { color: T3, fontFamily: DISPLAY, fontSize: 13 },
  ...
  retireBtnText: { fontFamily: FONT, fontSize: 16, fontWeight: '600', letterSpacing: -0.2 },
  ...
  statusPillText: { color: T1, fontFamily: FONT, fontSize: 14, fontWeight: '600' },
  dBrand: { color: T3, fontFamily: DISPLAY, fontSize: 13, fontWeight: '500', letterSpacing: 1.6 },
  dModel: { color: T1, fontFamily: DISPLAY, fontSize: 32, fontWeight: '700', letterSpacing: -0.5, marginTop: 2, lineHeight: 38 },
  dPurpose: { color: T2, fontFamily: FONT, fontSize: 16, fontWeight: '500', letterSpacing: -0.2, lineHeight: 22, marginTop: 10 },
  ...
  dTagText: { color: T2, fontFamily: FONT, fontSize: 13, fontWeight: '600' },
  ...
  dTypeChipText: { color: ACCENT, fontFamily: FONT, fontSize: 13, fontWeight: '700', letterSpacing: 0.1 },
  dPurposeLabel: { color: T3, fontFamily: FONT, fontSize: 14, fontWeight: '600', marginTop: 16 },
  ...
  runCtaText: { color: T2, fontFamily: FONT, fontSize: 16, fontWeight: '600', letterSpacing: -0.2 },
  ...
  retireLinkTxt: { flex: 1, color: T3, fontFamily: FONT, fontSize: 15, fontWeight: '600' },
  keepGoingText: { flex: 1, color: ACCENT, fontFamily: FONT, fontSize: 14, fontWeight: '600', letterSpacing: -0.1, lineHeight: 18 },
  // 은퇴 키프세이크 트리거 카드(수명 도달) — 자랑스러운 톤. accent 보더로 주목.
  keepsakeCard: { padding: 18, gap: 6, borderColor: withAlpha(ACCENT, 0.3) },
  keepsakeTitle: { color: T1, fontFamily: DISPLAY, fontSize: 19, fontWeight: '700', letterSpacing: -0.2 },
  keepsakeSub: { color: T3, fontFamily: FONT, fontSize: 14, lineHeight: 19 },
  ...
  keepsakeBtnTxt: { fontFamily: FONT, fontSize: 16, fontWeight: '700' },
  // 실효 마모 + 교체 예측 카드(차별점) — 본문 카드 톤에 accent 절제(라벨 아이콘/예측 라인만).
  wearCard: { padding: 18, gap: 2 },
  wearLabel: { color: T3, fontFamily: FONT, fontSize: 14, fontWeight: '600', letterSpacing: 0.2 },
  wearValue: { color: T1, fontFamily: DISPLAY, fontSize: 30, fontWeight: '700', letterSpacing: 0.3 },
  wearUnit: { color: T3, fontFamily: FONT, fontSize: 14, marginLeft: 4, marginBottom: 4 },
  wearTarget: { color: T3, fontFamily: FONT, fontSize: 14, marginBottom: 4 },
  wearForecast: { color: T3, fontFamily: FONT, fontSize: 14, fontWeight: '500', letterSpacing: -0.1, lineHeight: 18, marginTop: 8 },
  // 교체 예상 lead(핸드오프 lead 정합: 16px·lineHeight 23) + 주수 강조(bold·T1).
  replaceForecastText: { color: T2, fontFamily: FONT, fontSize: 17, fontWeight: '500', letterSpacing: -0.2, lineHeight: 23, marginTop: 8 },
  ...
  confChipText: { fontFamily: FONT, fontSize: 12, fontWeight: '700', letterSpacing: 0.1 },
  wearBasisText: { color: T3, fontFamily: FONT, fontSize: 14, fontWeight: '500', letterSpacing: -0.1, lineHeight: 18, marginTop: 8 },
  maxEditRow: { flexDirection: 'row', alignItems: 'center', gap: 4, alignSelf: 'flex-end', marginTop: 12 },
  maxEditTxt: { color: T3, fontFamily: FONT, fontSize: 13, fontWeight: '500' },
  gaugeNote: { marginTop: 10, color: T3, fontFamily: FONT, fontSize: 13, lineHeight: 17 },

  dHero: { padding: 24, flexDirection: 'row', alignItems: 'center', gap: 22 },
  dHeroPct: { color: T1, fontFamily: DISPLAY, fontSize: 30 },
  dHeroPctU: { color: T3, fontFamily: FONT, fontSize: 14 },
  dHeroLabel: { color: T3, fontFamily: FONT, fontSize: 14 },
  ...
  dHeroRemainU: { color: T2, fontFamily: FONT, fontSize: 17, marginLeft: 5, marginBottom: 6 },

  editInput: { backgroundColor: CARD_HI, borderRadius: 14, color: T1, fontFamily: FONT, fontSize: 17, fontWeight: '500', paddingHorizontal: 16, paddingVertical: 13 },
  editBtn: { flex: 1, height: 46, borderRadius: RADIUS.btn, alignItems: 'center', justifyContent: 'center' },
  editBtnTxt: { fontFamily: FONT, fontSize: 16, fontWeight: '600' },
  ...
  nextSub: { color: T3, fontFamily: FONT, fontSize: 14, lineHeight: 18, marginBottom: 6 },
  ...
  nextBrand: { color: T3, fontFamily: DISPLAY, fontSize: 11, fontWeight: '500', letterSpacing: 1.2 },
  nextModel: { color: T1, fontFamily: DISPLAY, fontSize: 16, fontWeight: '600', letterSpacing: -0.1, marginTop: 3 },
  nextCat: { color: T3, fontFamily: FONT, fontSize: 12, marginTop: 3 },
  ...
  shopBtnTxt: { color: ACCENT, fontFamily: FONT, fontSize: 13, fontWeight: '600' },
  nextDisclosure: { color: T3, fontFamily: FONT, fontSize: 12, lineHeight: 15, marginTop: 12, opacity: 0.85 },
  ...
  shareLine: { color: T3, fontFamily: FONT, fontSize: 13, paddingHorizontal: 18, paddingBottom: 14, marginTop: -2 },
  statValue: { color: T1, fontFamily: DISPLAY, fontSize: 23, letterSpacing: 0.3 },
  statUnit: { color: T3, fontFamily: FONT, fontSize: 13 },
  statLabel: { color: T3, fontFamily: FONT, fontSize: 12, marginTop: 4 },

  lastWorn: { color: T3, fontFamily: FONT, fontSize: 13, fontWeight: '500' },

  // 신발 수명(max_km) 조정 스테퍼 + 직접 입력
  maxInputRow: { flexDirection: 'row', alignItems: 'flex-end', justifyContent: 'center' },
  maxInput: { color: T1, fontFamily: DISPLAY, fontSize: 29, letterSpacing: 0.3, textAlign: 'center', minWidth: 70, paddingVertical: 0, paddingBottom: 2, borderBottomWidth: 1, borderBottomColor: withAlpha(ACCENT, 0.4) },
  maxStepUnit: { color: T3, fontFamily: FONT, fontSize: 14, marginBottom: 3 },
  maxStepCaption: { color: T3, fontFamily: FONT, fontSize: 13, fontWeight: '600', marginTop: 3 },
  maxHint: { color: T3, fontFamily: FONT, fontSize: 13, lineHeight: 18 },
  ...
  runDay: { color: T3, fontFamily: FONT, fontSize: 12, fontWeight: '500' },
  ...
  runDist: { color: T1, fontFamily: DISPLAY, fontSize: 22, letterSpacing: 0.3 },
  runDistU: { color: T3, fontFamily: FONT, fontSize: 14, marginLeft: 4, marginBottom: 1 },
  runSub: { color: T3, fontFamily: FONT, fontSize: 13, marginTop: 3 },
});
