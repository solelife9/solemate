...
const s = StyleSheet.create({
  ...
  navTitle: { color: T1, fontFamily: DISPLAY, fontSize: 17, fontWeight: '600', letterSpacing: -0.2 },
  ...
  bigUnit: { color: T2, fontFamily: FONT, fontSize: 27, fontWeight: '600', marginLeft: 8, marginBottom: 12 },
  estimate: { color: T3, fontFamily: FONT, fontSize: 14, fontWeight: '500', marginTop: 14 },
  ...
  tickLabel: { position: 'absolute', bottom: 2, width: 28, textAlign: 'center', color: T3, fontFamily: DISPLAY, fontSize: 13, fontWeight: '500' },
  ...
  presetText: { color: T2, fontFamily: DISPLAY, fontSize: 14, fontWeight: '600' },
  ...
  trackLbl: { color: T3, fontFamily: FONT, fontSize: 13, fontWeight: '700', letterSpacing: 1.6, textTransform: 'uppercase', marginBottom: 4 },
  ...
  lapChipVal: { color: T3, fontFamily: DISPLAY, fontSize: 19, fontWeight: '700', letterSpacing: -0.4 },
  lapChipValOn: { color: ACCENT },
  lapChipUnit: { color: T4, fontFamily: FONT, fontSize: 11, fontWeight: '600', marginTop: 1 },
  ...
  freeTitle: { color: T1, fontFamily: DISPLAY, fontSize: 25, fontWeight: '600', letterSpacing: -0.4, marginBottom: 10 },
  freeSub: { color: T3, fontFamily: FONT, fontSize: 15, fontWeight: '500', lineHeight: 21, textAlign: 'center', maxWidth: 250 },
  ...
  kpValGhost: { color: T4 },
  kpUnit: { color: T3, fontFamily: FONT, fontSize: 17, fontWeight: '600' },
  ...
  kpKeyTxt: { color: T1, fontFamily: DISPLAY, fontSize: 22, fontWeight: '600' },
  kpOk: { marginTop: 6 },
  pickerTitle: { color: T3, fontFamily: FONT, fontSize: 14, fontWeight: '600', letterSpacing: 0.2, marginBottom: 4 },
  ...
  pickerBrand: { color: T3, fontFamily: FONT, fontSize: 12, fontWeight: '600', letterSpacing: 0.6 },
  pickerModel: { color: T1, fontFamily: FONT, fontSize: 17, fontWeight: '700', letterSpacing: -0.2, marginTop: 1 },
  pickerMeta: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  pickerRemain: { color: T2, fontFamily: FONT, fontSize: 14, fontWeight: '500' },
  pickerCheck: { color: T1, fontFamily: FONT, fontSize: 17, fontWeight: '700', marginLeft: 2 },
  ...
  shoeBrand: { color: T3, fontFamily: DISPLAY, fontSize: 11, fontWeight: '600', letterSpacing: 1.4 },
  shoeModel: { color: T1, fontFamily: FONT, fontSize: 16, fontWeight: '600', letterSpacing: -0.2, marginTop: 2 },
  shoeCond: { flexDirection: 'row', alignItems: 'center', gap: 5, marginTop: 4 },
  shoeDot: { width: 6, height: 6, borderRadius: 999 },
  shoeCondText: { color: T3, fontFamily: FONT, fontSize: 13, fontWeight: '500' },
