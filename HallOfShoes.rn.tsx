...
const st = StyleSheet.create({
  ...
  subtitle: {fontFamily: FONT, fontSize: 13, fontWeight: '500', color: G.muted},
  ...
  llabel: {fontFamily: FONT, fontSize: 10, fontWeight: '700', letterSpacing: 1.2, color: G.faint},

  sec: {flexDirection: 'row', alignItems: 'baseline', justifyContent: 'space-between', marginBottom: 13},
  secT: {fontFamily: FONT, fontSize: 13, fontWeight: '700', color: G.txt},
  ...
  featName: {flex: 1},
  featBrand: {fontFamily: FONT, fontSize: 10, fontWeight: '700', letterSpacing: 1.8, color: G.gold},
  featModel: {fontFamily: SERIF, fontSize: 24, fontWeight: '700', color: G.txt, marginTop: 7},
  ...
  pmodel: {fontFamily: SERIF, fontSize: 16, fontWeight: '700', color: G.txt, marginTop: 5, lineHeight: 19},
  ...
  coDoctype: {fontFamily: SERIF, fontSize: 20, color: G.gold, letterSpacing: 5, marginTop: 8},
  coDoctypeKr: {fontFamily: FONT, fontSize: 12, fontWeight: '500', color: G.muted, letterSpacing: 0.3, marginTop: 8},
  coBrand: {fontFamily: FONT, fontSize: 11, fontWeight: '700', letterSpacing: 2.2, color: G.gold, marginTop: 32},
  coModel: {fontFamily: SERIF, fontSize: 27, fontWeight: '700', color: G.txt, marginTop: 7, textAlign: 'center'},
  coUnit: {fontFamily: FONT, fontSize: 11, fontWeight: '700', letterSpacing: 3.4, color: G.txt, marginTop: 12},
  ...
  coSealN: {fontFamily: SERIF, fontSize: 16, fontWeight: '700', color: G.gold, lineHeight: 18},
  ...
  coSignNm: {fontFamily: SERIF, fontSize: 19, fontWeight: '700', color: G.txt, marginTop: 5},
  ...
  coShareTxt: {fontFamily: FONT, fontSize: 11, fontWeight: '700', letterSpacing: 0.3, color: G.gold},
  coFoot: {flexDirection: 'row', alignItems: 'center', gap: 10, marginTop: 16},
  coFootLine: {width: 22, height: 1, backgroundColor: G.soft},
  coFootKg: {fontFamily: SERIF, fontSize: 10, fontWeight: '700', letterSpacing: 2.8, color: G.gold},
  ...
  eLabel: {fontFamily: FONT, fontSize: 11, fontWeight: '700', letterSpacing: 3.3, color: G.gold, marginTop: 30},
  eTitle: {fontFamily: SERIF, fontSize: 24, fontWeight: '700', color: G.txt, marginTop: 14},
