...
const st = StyleSheet.create({
  ...
  featModel: {fontFamily: SERIF, fontSize: TYPE.title.fontSize, fontWeight: '700', color: G.txt, marginTop: rv(7)},
  featQuote: {fontFamily: FONT, fontSize: TYPE.caption.fontSize, fontWeight: '600', color: G.muted, marginTop: rv(9)},
  ...
  pmodel: {fontFamily: SERIF, fontSize: TYPE.heading.fontSize, fontWeight: '700', color: G.txt, marginTop: rv(5), lineHeight: rf(19)},
  ...
  coModel: {fontFamily: SERIF, fontSize: TYPE.title1.fontSize, fontWeight: '700', color: G.txt, marginTop: rv(7), textAlign: 'center'},
