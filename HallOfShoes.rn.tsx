...
const st = StyleSheet.create({
  ...
  lcell: {flex: 1, alignItems: 'center', gap: rv(5)},
  ...
  sec: {flexDirection: 'row', alignItems: 'baseline', justifyContent: 'space-between', marginBottom: rv(13)},
  ...
  featModel: {fontFamily: SERIF, fontSize: rf(25), fontWeight: '700', color: G.txt, marginTop: rv(7)},
  featQuote: {fontFamily: FONT, fontSize: rf(13), fontWeight: '600', color: G.muted, marginTop: rv(9)},
  ...
  pmodel: {fontFamily: SERIF, fontSize: rf(17), fontWeight: '700', color: G.txt, marginTop: rv(5), lineHeight: rf(19)},
  ...
  coDoctype: {fontFamily: SERIF, fontSize: rf(21), color: G.gold, letterSpacing: 5, marginTop: rv(8)},
  coDoctypeKr: {fontFamily: FONT, fontSize: rf(13), fontWeight: '500', color: G.muted, letterSpacing: 0.3, marginTop: rv(8)},
  coBrand: {fontFamily: FONT, fontSize: rf(12), fontWeight: '700', letterSpacing: 2.2, color: G.gold, marginTop: rv(32)},
  coModel: {fontFamily: SERIF, fontSize: rf(28), fontWeight: '700', color: G.txt, marginTop: rv(7), textAlign: 'center'},
  coUnit: {fontFamily: FONT, fontSize: rf(12), fontWeight: '700', letterSpacing: 3.4, color: G.txt, marginTop: rv(12)},
  coQuote: {fontFamily: SERIF, fontSize: rf(17), fontWeight: '700', color: G.txt, marginTop: rv(20), textAlign: 'center'},
  coMeta: {flexDirection: 'row', alignSelf: 'stretch', marginTop: rv(28)},
  coCell: {flex: 1, gap: rv(5), paddingHorizontal: rs(8), alignItems: 'center'},
  ...
  coRunner: {alignItems: 'flex-start', paddingTop: rv(8), gap: rv(5)},
  coSign: {alignItems: 'flex-end'},
  coSignK: {fontFamily: SERIF, fontSize: rf(8), fontWeight: '700', letterSpacing: 1.4, color: G.faint},
  coSignNm: {fontFamily: SERIF, fontSize: rf(20), fontWeight: '700', color: G.txt, marginTop: rv(5)},
  ...
  eLabel: {fontFamily: FONT, fontSize: rf(12), fontWeight: '700', letterSpacing: 3.3, color: G.gold, marginTop: rv(30)},
  eTitle: {fontFamily: SERIF, fontSize: rf(25), fontWeight: '700', color: G.txt, marginTop: rv(14)},
  eDesc: {fontSize: rf(15), fontWeight: '500', color: G.muted, lineHeight: rf(23), marginTop: rv(14), textAlign: 'center', maxWidth: rs(286)},
