...
const s = StyleSheet.create({
  ...
  title: {color: T1, fontFamily: FONT, fontSize: 23, fontWeight: '700', letterSpacing: -0.4},
  shoe: {color: T3, fontFamily: FONT, fontSize: 14, fontWeight: '600'},
  hero: {flexDirection: 'row', alignItems: 'flex-end', justifyContent: 'center', gap: 6, marginTop: 8, marginBottom: 14},
  heroNum: {color: T1, fontFamily: DISPLAY, fontSize: 68, fontWeight: '700', letterSpacing: -2, lineHeight: 72},
  heroUnit: {color: T2, fontFamily: FONT, fontSize: 21, fontWeight: '700', marginBottom: 10},
  ...
  badgeTxt: {fontFamily: FONT, fontSize: 14, fontWeight: '700'},
  ...
  raceBannerTitle: {flex: 1, color: HALL_GOLD, fontFamily: FONT, fontSize: 16, fontWeight: '700', letterSpacing: -0.2},
  raceBannerDesc: {color: T2, fontFamily: FONT, fontSize: 14, marginTop: 6, lineHeight: 18},
  ...
  raceBannerPrimaryT: {color: HALL_GOLD, fontFamily: FONT, fontSize: 15, fontWeight: '700'},
  raceBannerGhost: {height: 42, paddingHorizontal: 14, alignItems: 'center', justifyContent: 'center'},
  raceBannerGhostT: {color: T3, fontFamily: FONT, fontSize: 14, fontWeight: '500'},
  ...
  statValue: {color: T1, fontFamily: DISPLAY, fontSize: 27, fontWeight: '700', letterSpacing: -0.6},
  statLabel: {color: T3, fontFamily: FONT, fontSize: 13, fontWeight: '600', marginTop: 3},
  statSub: {color: T3, fontFamily: FONT, fontSize: 12, fontWeight: '500'},
  ...
  shoeName: {color: T1, fontFamily: FONT, fontSize: 16, fontWeight: '700', letterSpacing: -0.2},
  shoeMeta: {color: T2, fontFamily: FONT, fontSize: 14, fontWeight: '500', marginTop: 2},
  ...
  loadTxt: {flex: 1, color: T2, fontFamily: FONT, fontSize: 14, fontWeight: '500'},
  ...
  planTitle: {color: T1, fontFamily: FONT, fontSize: 16, fontWeight: '700'},
  planSummary: {fontFamily: FONT, fontSize: 14, fontWeight: '700'},
  planRow: {flexDirection: 'row', alignItems: 'center', paddingVertical: 7, borderTopWidth: StyleSheet.hairlineWidth, borderTopColor: SEP},
  planKm: {color: T3, fontFamily: FONT, fontSize: 14, fontWeight: '700', width: 42},
  planTgt: {color: T3, fontFamily: FONT, fontSize: 14, fontWeight: '500', flex: 1},
  planAct: {color: T1, fontFamily: FONT, fontSize: 15, fontWeight: '700', width: 64, textAlign: 'right'},
  planDelta: {fontFamily: FONT, fontSize: 14, fontWeight: '700', width: 52, textAlign: 'right'},
  ...
  doneTxt: {color: T1, fontFamily: FONT, fontSize: 17, fontWeight: '700'},
  ...
  metaPhotoAddTxt: {color: T2, fontFamily: FONT, fontSize: 14, fontWeight: '600'},
  metaInput: {color: T1, fontFamily: FONT, fontSize: 15, paddingVertical: 8, paddingHorizontal: 2, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: SEP},
