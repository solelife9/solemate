...
const s = StyleSheet.create({
  ...
  grid: {flexDirection: 'row', flexWrap: 'wrap', backgroundColor: GLASS.fill, borderRadius: RADIUS.lg, borderWidth: StyleSheet.hairlineWidth, borderColor: SEP, paddingVertical: rv(6)},
  ...
  shoeCard: {flexDirection: 'row', alignItems: 'center', gap: rv(12), backgroundColor: GLASS.fill, borderRadius: RADIUS.lg, borderWidth: StyleSheet.hairlineWidth, borderColor: SEP, paddingHorizontal: rs(14), paddingVertical: rv(12), marginBottom: rv(12)},
  ...
  plan: {backgroundColor: GLASS.fill, borderRadius: RADIUS.lg, borderWidth: StyleSheet.hairlineWidth, borderColor: SEP, paddingHorizontal: rs(16), paddingVertical: rv(12), marginTop: rv(12)},
