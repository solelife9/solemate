...
const s = StyleSheet.create({
  ...
  addBtnText: { color: T1, fontFamily: FONT, fontSize: 14, fontWeight: '600' },
  ...
  date: { color: T3, fontFamily: FONT, fontSize: 14, letterSpacing: 0.2 },
  greet: { color: T1, fontFamily: FONT, fontSize: 21, fontWeight: '500', letterSpacing: -0.4, marginTop: 3, lineHeight: 26 },
  ...
  syncChipTxt: { color: T3, fontFamily: FONT, fontSize: 13, fontWeight: '500', letterSpacing: 0.1 },
  ...
  equipPillTxt: { color: T2, fontFamily: FONT, fontSize: 13, fontWeight: '600', letterSpacing: 0.1 },
  ...
  goalSub: { color: T3, fontFamily: FONT, fontSize: 13, fontWeight: '500' },
  ...
  weekStreakTxt: { color: ACCENT, fontFamily: FONT, fontSize: 13, fontWeight: '700' },
  weekGoalTxt: { color: T3, fontFamily: FONT, fontSize: 14, fontWeight: '500' },
  ...
  streakText: { fontFamily: FONT, fontSize: 13, fontWeight: '600', letterSpacing: 0.1 },
  goalRingPct: { color: T1, fontFamily: DISPLAY, fontSize: 18, letterSpacing: 0.2 },
  goalRingU: { color: T3, fontFamily: FONT, fontSize: 11 },
  ...
  weekEmptyTxt: { color: T3, fontFamily: FONT, fontSize: 14, lineHeight: 19 },
  ...
  insightLabel: { color: T3, fontFamily: FONT, fontSize: 14, fontWeight: '600', letterSpacing: -0.1 },
  insightNum: { color: T1, fontFamily: DISPLAY, fontSize: 23, fontWeight: '700', letterSpacing: -0.4 },
  insightUnit: { color: T3, fontFamily: FONT, fontSize: 14, fontWeight: '500', marginLeft: 2 },
  insightWeeks: { fontFamily: DISPLAY, fontSize: 23, fontWeight: '700', letterSpacing: -0.4, marginTop: 6 },
  insightSub: { color: T3, fontFamily: FONT, fontSize: 14, fontWeight: '500', marginTop: 3 },
  ...
  insightPurposeText: { color: T2, fontFamily: FONT, fontSize: 16, fontWeight: '500', letterSpacing: -0.2, lineHeight: 22, marginTop: 6 },
  ...
  insightTagText: { color: T2, fontFamily: FONT, fontSize: 13, fontWeight: '600' },
  heroTop: { flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'space-between', gap: 14 },
  heroBrand: { color: T3, fontFamily: DISPLAY, fontSize: 12, fontWeight: '500', letterSpacing: 1.4 },
  usingChip: { backgroundColor: CARD_HI, borderRadius: 6, paddingHorizontal: SPACE.sm, paddingVertical: 2 },
  usingChipText: { color: T3, fontFamily: FONT, fontSize: 11, fontWeight: '500' },
  ...
  catChipText: { color: ACCENT, fontFamily: FONT, fontSize: 11, fontWeight: '700', letterSpacing: 0.1 },
  heroModel: { color: T1, fontFamily: DISPLAY, fontSize: 28, fontWeight: '700', letterSpacing: -0.6, marginTop: 7, lineHeight: 32, marginBottom: 24 },
  // minHeight = 2줄(lineHeight 20×2) — 1줄짜리 reason 도 2줄 공간을 차지해 캐러셀 카드
  // 높이가 신발마다 흔들리지 않게 한다(numberOfLines={2} 와 짝).
  heroReason: { color: T2, fontFamily: FONT, fontSize: 16, fontWeight: '500', letterSpacing: -0.2, marginTop: 6, lineHeight: 21, minHeight: 21 },
  // 교체까지 남은 거리 — 문장형(목업 .remain). 숫자만 디스플레이 강조.
  heroRemainLine: { color: T2, fontFamily: FONT, fontSize: 16, fontWeight: '500', letterSpacing: -0.2, marginTop: 10 },
  heroRemainNum: { color: T1, fontFamily: DISPLAY, fontSize: 27, fontWeight: '700', letterSpacing: -0.6 },
  heroRemainNumU: { color: T2, fontFamily: FONT, fontSize: 14, fontWeight: '500' },
  ...
  usage: { color: T3, fontFamily: FONT, fontSize: 13, fontWeight: '500' },
  usagePct: { color: T2, fontFamily: FONT, fontSize: 13, fontWeight: '700', letterSpacing: 0.2 },
  ...
  heroForecastText: { flex: 1, color: T3, fontFamily: FONT, fontSize: 14, fontWeight: '500', letterSpacing: -0.1, lineHeight: 16 },
  ...
  sectionMore: { color: T4, fontFamily: FONT, fontSize: 13, fontWeight: '500' },
  ...
  chalLabel: { color: T3, fontFamily: FONT, fontSize: 13, fontWeight: '600', letterSpacing: 0.6, textTransform: 'uppercase', flex: 1 },
  chalMore: { color: ACCENT, fontFamily: FONT, fontSize: 13, fontWeight: '600' },
  chalEmpty: { alignItems: 'center', paddingVertical: 8 },
  chalEmptyTxt: { color: T2, fontFamily: FONT, fontSize: 15, fontWeight: '500' },
  chalEmptyHint: { color: T3, fontFamily: FONT, fontSize: 13, marginTop: 4 },
  ...
  chalItemLabel: { color: T1, fontFamily: FONT, fontSize: 14, fontWeight: '500', flex: 1 },
  ...
  chalPct: { color: T3, fontFamily: FONT, fontSize: 12, marginTop: 5 },
  ...
  rotaBrand: { color: T3, fontFamily: DISPLAY, fontSize: 12, fontWeight: '500', letterSpacing: 1.2 },
  rotaModel: { color: T1, fontFamily: DISPLAY, fontSize: 16, fontWeight: '600', letterSpacing: -0.1, marginTop: 4 },
  // 로테이션 인사이트 행
  ...
  insightBadgeText: { fontFamily: FONT, fontSize: 13, fontWeight: '600', letterSpacing: -0.1 },
  insightDesc: { color: T3, fontFamily: FONT, fontSize: 14, letterSpacing: -0.1, marginTop: 5, lineHeight: 18 },
  ...
  nextSub: { color: T3, fontFamily: FONT, fontSize: 14, lineHeight: 18, marginBottom: SPACE.sm },
  ...
  nextDisclosure: { color: T3, fontFamily: FONT, fontSize: 12, lineHeight: 15, marginTop: SPACE.md, opacity: 0.85 },



  // 빈 홈 — 고스트 카드(KeegoHome GhostShoeCard) + 철학 한 줄. 구 대시 슬롯 스타일 폐기.
  empty: { paddingTop: 4, alignItems: 'center', gap: 26 },
  emptyPhilosophy: { textAlign: 'center', color: T3, fontFamily: FONT, fontSize: 16, lineHeight: 24 },
});
