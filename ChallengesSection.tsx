...
const s = StyleSheet.create({
  ...
  sectionLabel: {color: T2, fontFamily: FONT, fontSize: 15, fontWeight: '500', letterSpacing: 0.2},
  ...
  addBtnTxt: {color: ACCENT, fontFamily: FONT, fontSize: 14, fontWeight: '700'},

  empty: {color: T3, fontFamily: FONT, fontSize: 14, lineHeight: 19, paddingHorizontal: 4},
  ...
  ringPct: {color: T1, fontFamily: DISPLAY, fontSize: 15, letterSpacing: 0.2},
  titleRow: {flexDirection: 'row', alignItems: 'center', gap: 8},
  title: {flex: 1, color: T1, fontFamily: FONT, fontSize: 17, fontWeight: '700', letterSpacing: -0.2},
  progressTxt: {marginTop: 4},
  progressCur: {color: T1, fontFamily: DISPLAY, fontSize: 19, letterSpacing: 0.2},
  progressTot: {color: T3, fontFamily: FONT, fontSize: 14, fontWeight: '700'},
  period: {color: T3, fontFamily: FONT, fontSize: 12, fontWeight: '500', marginTop: 4},
  ...
  segTxt: {color: T2, fontFamily: FONT, fontSize: 15, fontWeight: '600'},
  ...
  stepNum: {color: T1, fontFamily: DISPLAY, fontSize: 27, letterSpacing: 0.3},
  stepUnit: {color: T3, fontFamily: FONT, fontSize: 13, fontWeight: '600', marginTop: 2},
  ...
  xpHintTxt: {color: ACCENT, fontFamily: FONT, fontSize: 13, fontWeight: '600'},
  xpEarned: {color: ACCENT, fontFamily: FONT, fontSize: 13, fontWeight: '700', marginTop: 2},

  // ── 확장 챌린지(Slice C) ──
  extWrap: {marginTop: 18, gap: 10},
  extLabel: {paddingHorizontal: 4, paddingBottom: 2},
  extProgress: {color: T1, fontFamily: DISPLAY, fontSize: 18, letterSpacing: 0.2, marginTop: 4},
  ...
  smartTitle: {color: T1, fontFamily: FONT, fontSize: 18, fontWeight: '700', letterSpacing: -0.2},
  smartReason: {color: T2, fontFamily: FONT, fontSize: 14, fontWeight: '500', lineHeight: 18, marginTop: 4},
  ...
  smartEditLabel: {color: T2, fontFamily: FONT, fontSize: 14, fontWeight: '600', letterSpacing: 0.2},
  smartStepVal: {color: T1, fontFamily: DISPLAY, fontSize: 25, letterSpacing: 0.2},
  smartStepUnit: {color: T3, fontFamily: FONT, fontSize: 15, fontWeight: '600'},
});
