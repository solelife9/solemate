...
const s = StyleSheet.create({
  ...
  empty: {color: T3, fontFamily: FONT, fontSize: rf(14), lineHeight: rf(19), paddingHorizontal: 4},
  ...
  period: {color: T3, fontFamily: FONT, fontSize: rf(12), fontWeight: '500', marginTop: 4},
  ...
  stepUnit: {color: T3, fontFamily: FONT, fontSize: rf(13), fontWeight: '600', marginTop: 2},
  ...
  xpEarned: {color: ACCENT, fontFamily: FONT, fontSize: rf(13), fontWeight: '700', marginTop: 2},

  // ── 확장 챌린지(Slice C) ──
  extWrap: {marginTop: 18, gap: 10},
  extLabel: {paddingHorizontal: 4, paddingBottom: 2},
  extProgress: {color: T1, fontFamily: DISPLAY, fontSize: rf(18), letterSpacing: 0.2, marginTop: 4},
  ...
  smartReason: {color: T2, fontFamily: FONT, fontSize: rf(14), fontWeight: '500', lineHeight: rf(18), marginTop: 4},
