...
export const GLASS = {
  ...
  // 변을 따라 길게 자연 감쇠. 베이스 헤어라인은 0.07(2026-07-10 확정 — "카드 전체를
  // 제일 얇은 헤어라인으로 감싸기"): 콰이어트 카드의 CARD_BORDER 와 같은 시감으로,
  // 유리 요소도 전 둘레가 또렷이 닫힌다. 글린트는 그 위에 얹히는 빛.
  edgeBase: 0.07,                   // 전 둘레 헤어라인 — CARD_BORDER 와 동일 시감
  edgeTL: 0.3,                      // 좌상 코너 주광
