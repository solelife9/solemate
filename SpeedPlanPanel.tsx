...
const s = StyleSheet.create({
  ...
  tuneRow: {backgroundColor: CARD, borderRadius: RADIUS.lg, borderCurve: 'continuous', borderWidth: 1, borderColor: SEP, paddingHorizontal: rs(16), paddingVertical: rv(12)},
