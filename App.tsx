...
const boot=StyleSheet.create({
  ...
  cardTitle:{color:T1,fontFamily:FP,fontSize:19,fontWeight:'700',marginTop:4},
  cardBody:{color:T3,fontFamily:FP,fontSize:15,lineHeight:20,textAlign:'center'},
  loadingCaption:{color:T3,fontFamily:FP,fontSize:14,lineHeight:19},
...
const run=StyleSheet.create({
  ...
  liveText:{fontFamily:FP,fontSize:15,fontWeight:'500',letterSpacing:0.3},
  ...
  shoeChipText:{color:T3,fontFamily:FH,fontSize:14,fontWeight:'600'},
  ...
  bigUnit:{color:T3,fontFamily:FP,fontSize:15,fontWeight:'600',marginTop:2},
  ...
  metricU:{color:T3,fontFamily:FP,fontSize:12,marginBottom:3},
  metricL:{color:T3,fontFamily:FP,fontSize:13,fontWeight:'600'},
  ...
  hmL:{color:T3,fontFamily:FP,fontSize:13,fontWeight:'500',marginTop:5},
  ...
  discardTxt:{color:T1,fontSize:17,fontFamily:FP,fontWeight:'600'},
