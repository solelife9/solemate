...
const m = StyleSheet.create({
  ...
  navTitle: {color: T1, fontFamily: FONT, fontSize: 16, fontWeight: '600', letterSpacing: -0.2},

  head: {flexDirection: 'row', alignItems: 'baseline', justifyContent: 'space-between', marginBottom: 4},
  h: {color: T1, fontFamily: DISPLAY, fontSize: 24, fontWeight: '700', letterSpacing: -0.5},
  count: {color: HALL_GOLD, fontFamily: FONT, fontSize: 12, fontWeight: '600'},
  sub: {color: T3, fontFamily: FONT, fontSize: 13, marginBottom: 8},
  ...
  cellName: {color: T2, fontFamily: FONT, fontSize: 11, fontWeight: '600', letterSpacing: -0.2, textAlign: 'center', lineHeight: 14},
  cellTime: {color: HALL_GOLD, fontFamily: FONT, fontSize: 11, fontWeight: '700', fontVariant: ['tabular-nums']},
  ...
  detailName: {color: T1, fontFamily: FONT, fontSize: 20, fontWeight: '700', letterSpacing: -0.4, textAlign: 'center', marginTop: 20, textWrap: 'balance'} as any,
  ...
  detailNote: {color: T3, fontFamily: FONT, fontSize: 12, marginTop: 6, textAlign: 'center'},
  ...
  detailRowL: {color: T3, fontFamily: FONT, fontSize: 13},
  detailRowV: {color: T1, fontFamily: FONT, fontSize: 14, fontWeight: '600', fontVariant: ['tabular-nums']},
  certWrap: {alignSelf: 'stretch', marginTop: 18, gap: 8},
  certLabel: {color: T3, fontFamily: FONT, fontSize: 12, fontWeight: '600', letterSpacing: 0.4},
  ...
  runLinkT: {color: ACCENT, fontFamily: FONT, fontSize: 14, fontWeight: '600'},
});
